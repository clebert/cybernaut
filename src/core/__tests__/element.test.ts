  ...
  describe('when element.sendKeys() is called', () => {
    ...
    test('then it should return an action', () => {
      expect(action.description).toBe(
        ...
        'to the <elementName> element'
      );

      expect(element.sendKeys(Key.NULL).description).toBe(
        'Send the specified key (Key.NULL) to the <elementName> element'
      );

      expect(element.sendKeys(Key.CANCEL).description).toBe(
        'Send the specified key (Key.CANCEL) to the <elementName> element'
      );

      expect(element.sendKeys(Key.HELP).description).toBe(
        'Send the specified key (Key.HELP) to the <elementName> element'
      );

      expect(element.sendKeys(Key.BACK_SPACE).description).toBe(
        'Send the specified key (Key.BACK_SPACE) to the <elementName> element'
      );

      expect(element.sendKeys(Key.TAB).description).toBe(
        'Send the specified key (Key.TAB) to the <elementName> element'
      );

      expect(element.sendKeys(Key.CLEAR).description).toBe(
        'Send the specified key (Key.CLEAR) to the <elementName> element'
      );

      expect(element.sendKeys(Key.RETURN).description).toBe(
        'Send the specified key (Key.RETURN) to the <elementName> element'
      );

      expect(element.sendKeys(Key.ENTER).description).toBe(
        'Send the specified key (Key.ENTER) to the <elementName> element'
      );

      expect(element.sendKeys(Key.SHIFT).description).toBe(
        'Send the specified key (Key.SHIFT) to the <elementName> element'
      );

      expect(element.sendKeys(Key.CONTROL).description).toBe(
        'Send the specified key (Key.CONTROL) to the <elementName> element'
      );

      expect(element.sendKeys(Key.ALT).description).toBe(
        'Send the specified key (Key.ALT) to the <elementName> element'
      );

      expect(element.sendKeys(Key.PAUSE).description).toBe(
        'Send the specified key (Key.PAUSE) to the <elementName> element'
      );

      expect(element.sendKeys(Key.ESCAPE).description).toBe(
        'Send the specified key (Key.ESCAPE) to the <elementName> element'
      );

      expect(element.sendKeys(Key.SPACE).description).toBe(
        'Send the specified key (Key.SPACE) to the <elementName> element'
      );

      expect(element.sendKeys(Key.PAGE_UP).description).toBe(
        'Send the specified key (Key.PAGE_UP) to the <elementName> element'
      );

      expect(element.sendKeys(Key.PAGE_DOWN).description).toBe(
        'Send the specified key (Key.PAGE_DOWN) to the <elementName> element'
      );

      expect(element.sendKeys(Key.END).description).toBe(
        'Send the specified key (Key.END) to the <elementName> element'
      );

      expect(element.sendKeys(Key.HOME).description).toBe(
        'Send the specified key (Key.HOME) to the <elementName> element'
      );

      expect(element.sendKeys(Key.ARROW_LEFT).description).toBe(
        'Send the specified key (Key.LEFT) to the <elementName> element'
      );
      ...
      expect(element.sendKeys(Key.ARROW_UP).description).toBe(
        'Send the specified key (Key.UP) to the <elementName> element'
      );
      ...
      expect(element.sendKeys(Key.ARROW_RIGHT).description).toBe(
        'Send the specified key (Key.RIGHT) to the <elementName> element'
      );
      ...
      expect(element.sendKeys(Key.ARROW_DOWN).description).toBe(
        'Send the specified key (Key.DOWN) to the <elementName> element'
      );
      ...
      expect(element.sendKeys(Key.INSERT).description).toBe(
        'Send the specified key (Key.INSERT) to the <elementName> element'
      );

      expect(element.sendKeys(Key.DELETE).description).toBe(
        'Send the specified key (Key.DELETE) to the <elementName> element'
      );

      expect(element.sendKeys(Key.SEMICOLON).description).toBe(
        'Send the specified key (Key.SEMICOLON) to the <elementName> element'
      );

      expect(element.sendKeys(Key.EQUALS).description).toBe(
        'Send the specified key (Key.EQUALS) to the <elementName> element'
      );

      expect(element.sendKeys(Key.NUMPAD0).description).toBe(
        'Send the specified key (Key.NUMPAD0) to the <elementName> element'
      );

      expect(element.sendKeys(Key.NUMPAD1).description).toBe(
        'Send the specified key (Key.NUMPAD1) to the <elementName> element'
      );

      expect(element.sendKeys(Key.NUMPAD2).description).toBe(
        'Send the specified key (Key.NUMPAD2) to the <elementName> element'
      );

      expect(element.sendKeys(Key.NUMPAD3).description).toBe(
        'Send the specified key (Key.NUMPAD3) to the <elementName> element'
      );

      expect(element.sendKeys(Key.NUMPAD4).description).toBe(
        'Send the specified key (Key.NUMPAD4) to the <elementName> element'
      );

      expect(element.sendKeys(Key.NUMPAD5).description).toBe(
        'Send the specified key (Key.NUMPAD5) to the <elementName> element'
      );

      expect(element.sendKeys(Key.NUMPAD6).description).toBe(
        'Send the specified key (Key.NUMPAD6) to the <elementName> element'
      );

      expect(element.sendKeys(Key.NUMPAD7).description).toBe(
        'Send the specified key (Key.NUMPAD7) to the <elementName> element'
      );

      expect(element.sendKeys(Key.NUMPAD8).description).toBe(
        'Send the specified key (Key.NUMPAD8) to the <elementName> element'
      );

      expect(element.sendKeys(Key.NUMPAD9).description).toBe(
        'Send the specified key (Key.NUMPAD9) to the <elementName> element'
      );

      expect(element.sendKeys(Key.MULTIPLY).description).toBe(
        'Send the specified key (Key.MULTIPLY) to the <elementName> element'
      );

      expect(element.sendKeys(Key.ADD).description).toBe(
        'Send the specified key (Key.ADD) to the <elementName> element'
      );

      expect(element.sendKeys(Key.SEPARATOR).description).toBe(
        'Send the specified key (Key.SEPARATOR) to the <elementName> element'
      );

      expect(element.sendKeys(Key.SUBTRACT).description).toBe(
        'Send the specified key (Key.SUBTRACT) to the <elementName> element'
      );

      expect(element.sendKeys(Key.DECIMAL).description).toBe(
        'Send the specified key (Key.DECIMAL) to the <elementName> element'
      );

      expect(element.sendKeys(Key.DIVIDE).description).toBe(
        'Send the specified key (Key.DIVIDE) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F1).description).toBe(
        'Send the specified key (Key.F1) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F2).description).toBe(
        'Send the specified key (Key.F2) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F3).description).toBe(
        'Send the specified key (Key.F3) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F4).description).toBe(
        'Send the specified key (Key.F4) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F5).description).toBe(
        'Send the specified key (Key.F5) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F6).description).toBe(
        'Send the specified key (Key.F6) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F7).description).toBe(
        'Send the specified key (Key.F7) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F8).description).toBe(
        'Send the specified key (Key.F8) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F9).description).toBe(
        'Send the specified key (Key.F9) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F10).description).toBe(
        'Send the specified key (Key.F10) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F11).description).toBe(
        'Send the specified key (Key.F11) to the <elementName> element'
      );

      expect(element.sendKeys(Key.F12).description).toBe(
        'Send the specified key (Key.F12) to the <elementName> element'
      );

      expect(element.sendKeys(Key.COMMAND).description).toBe(
        'Send the specified key (Key.META) to the <elementName> element'
      );
