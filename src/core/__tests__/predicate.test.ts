...
import {given, then, when} from './test-utils';
...
given('a predicate is built via contain()', () => {
  ...
  when('predicate.compare() is called', () => {
    then('it should return a comparison', async () => {
      expect(predicate.compare('bar')).toBe("expected 'bar' to contain 'foo'");
    });
  });

  when('predicate.description is accessed', () => {
    then('it should evaluate to a description', async () => {
...
given('a predicate is built via not.contain()', () => {
  let predicate: Predicate<string>;
...
given('a predicate is built via equal()', () => {
...
given('a predicate is built via not.equal()', () => {
  let predicate: Predicate<object>;
...
given('a predicate is built via match()', () => {
  let predicate: Predicate<string>;
...
given('a predicate is built via not.match()', () => {
  let predicate: Predicate<string>;
...
given('a predicate is built via beBetween()', () => {
...
given('a predicate is built via not.beBetween()', () => {
  let predicate: Predicate<number>;
...
given('a predicate is built via beGreaterThan()', () => {
  let predicate: Predicate<number>;
...
given('a predicate is built via not.beGreaterThan()', () => {
  let predicate: Predicate<number>;
...
given('a predicate is built via beGreaterThanOrEqual()', () => {
  let predicate: Predicate<number>;
...
given('a predicate is built via not.beGreaterThanOrEqual()', () => {
  let predicate: Predicate<number>;
...
given('a predicate is built via beLessThan()', () => {
  let predicate: Predicate<number>;
...
given('a predicate is built via not.beLessThan()', () => {
  let predicate: Predicate<number>;
...
given('a predicate is built via beLessThanOrEqual()', () => {
  let predicate: Predicate<number>;
...
given('a predicate is built via not.beLessThanOrEqual()', () => {
  let predicate: Predicate<number>;
